...
const populationDao = {
  ...
  getPopulationAverage: (callback) => {
    ...
    const avgAgePopulationByAge = { $group: { _id: '$_id.age', avgAgePopulation: { $avg: '$totalPopulation' } } };
    const setFormat = {$project:{age: '$_id', avgAgePopulation: '$avgAgePopulation', _id: 0}};
    const sortByAgeAscending = {$sort:{age: 1}};
